...
/**
 * Examples class for green greyscale command macro used for testing.
 */
public class GreenGreyScaleMacroTest {
  ...
  public void greenGreyScaleMacroTest1() {
    ...
    assertEquals(25, image1.getPixels().get(1).get(2).getR());
    assertEquals(25, image1.getPixels().get(1).get(2).getG());
    assertEquals(25, image1.getPixels().get(1).get(2).getB());

  }

  @Test
  public void greenGreyScaleMacroTest2() {
